...
Приложение должно выводить на экран сообщение, в зависимости от текущего времени суток.
...
Выводящиеся на консоль сообщения должны быть получены из message resource. Сделать перевод для русского языка.
